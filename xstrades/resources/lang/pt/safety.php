<?php
    return [
        ...
        "SECTION_2_TITLE" => "Separação do Fundos do Cliente ",
        "SECTION_2_DESCRIPTION" => "Todas as contas de clientes são segregadas dos fundos da empresa, sendo mantidas em contas segregadas nas instituições financeiras mais respeitáveis em todo o mundo.",
        "SECTION_2_BUTTON_TEXT" => "Métodos de Movimentação",
 
        "SECTION_3_TITLE" => "Regulações Multiplas",
        "SECTION_3_DESCRIPTION" => "A XS Group é uma fornecedora de serviços financeiros e fintech multinacional, com entidades regulamentadas e autorizadas em várias jurisdições ao redor do mundo. Estamos constantemente trabalhando para estar em conformidade com as diretrizes regulatórias internacionais mais rigorosas.",
        ...
        "SECTION_5_DESCRIPTION" => "Desde 2010, o Grupo XS tem fornecido a traders, investidores institucionais e corretores em todo o mundo o acesso a uma liquidez institucional profunda e tecnologia de negociação avançada, combinada com uma experiência de usuário eficiente, gerenciamento de relacionamento de alta qualidade e excelente suporte ao cliente",
        "SECTION_5_BUTTON_TEXT" => "História",
    ];