<?php
return [
    'HOLIDAYS_HOURS_TITLE' => 'Jours Fériés de Trading ',
    'HOLIDAYS_HOURS_DESC' => '
    ...
    'UPCOMING_DESC' => 'Aucun jour férié à venir.',

    'NOTICES_HOURS_TITLE' => 'Avis de Trading ',
    'NOTICES_HOURS_DESC' => '
    Les conditions normales de trading peuvent être influencées par divers facteurs saisonniers et de marché. La section ci-dessous présente les dernières mises à jour concernant les événements à venir et leur impact sur les conditions de trading.
    <br/><br/>
    Toutes les heures dans les tableaux ci-dessous sont en temps serveur (GMT+3).',
    
    'UPCOMING_NOTICES_TITLE' => 'Annonces à Venir',
    'UPCOMING_NOTICES_DESC' => 'Aucune annonce à venir.',
];
?>