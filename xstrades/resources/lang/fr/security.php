...
return [
    ...
    'STAYING_SAFE' => 'SÉCURITÉ EN LIGNE',
    'PAGE_BANNER_SUBTITLE'=>'Nous mettons en œuvre des protocoles de sécurité avancés pour protéger vos informations et vos fonds.',

    'WE_PTIORITIZE' => 'Nous priorisons la sécurité et la sûreté des données et des fonds des clients en investissant continuellement dans notre infrastructure et en mettant en œuvre des protocoles de sécurité avancés pour maintenir les normes de sécurité les plus élevées. Nous comprenons l’importance des transactions sécurisées; par conséquent, nous utilisons des protocoles de cryptage robustes pour protéger vos informations et vos fonds.',
    ...
    'SECURE_BROWSING' => 'Navigation sécurisée : ',
    'SECURE_BROWSING_DESC' => 'Lorsque vous naviguez sur le Web, assurez-vous que les sites Web que vous visitez ont le préfixe "https:/" et affichent une icône de cadenas sécurisé dans la barre d’URL. Soyez vigilant pour le spoofing de site Web, une technique où les sites Web légitimes sont clonés pour recueillir des informations sur les clients, souvent facilitées par des e-mails de phishing ou des fenêtres pop-up. Optez toujours pour des connexions Internet sécurisées via le Wi-Fi public et évitez d’enregistrer les informations de connexion sur les ordinateurs partagés. N’oubliez pas d’effacer votre cache et les cookies après chaque session pour plus de sécurité.',

    'PROTECTION_FROM_VIRUSES' => 'Protection contre les virus et les logiciels malveillants : ',
    'PROTECTION_FROM_VIRUSES_DESC' => 'Les logiciels malveillants et les virus peuvent compromettre la sécurité de votre appareil et tenter de voler votre identité ou vos fonds. Évitez de télécharger des fichiers ou des programmes à partir de sources non vérifiées et gardez le logiciel antivirus de votre appareil à jour.',
    ...
    'CHANGE_YOUR_PASSWORD' => 'Changez vos mots de passe : ',
    ...
    'AVOID_CLICKING' => 'Évitez de cliquer sur des liens suspects ou de télécharger des pièces jointes : ',
    'AVOID_CLICKING_DESC' => 'Ne cliquez sur aucun lien ou ne téléchargez pas de pièces jointes à partir de messages suspects. Ceux-ci peuvent contenir des logiciels malveillants ou des tentatives d’hameçonnage conçus pour compromettre votre sécurité.',

    'RERORTING_SUSPICIOUS' => 'Signalement des activités suspectes : ',
    'RERORTING_SUSPICIOUS_DESC' => 'Lorsque vous signalez une activité suspecte en ligne, vous prenez position pour la sécurité en ligne.
