<?php 
    return [
        ...
        'SECURITY_TITLE' => 'Seguridad y protección de fondos',

        'SECURITY_DESCRIPTION' => 'Priorizamos la seguridad y protección de los fondos en nuestros procesos de depósito y retiro y empleamos protocolos de encriptación robustos para salvaguardar su información financiera. 
        <br/>
        ...
        'SUPPORT_TITLE' => 'Soporte al Cliente Premium',

        'SUPPORT_DESCRIPTION' => 'Nuestro equipo de soporte al cliente está disponible para ayudarle durante todo el proceso de depósito y retiro. Si encuentra algún problema o tiene preguntas sobre sus transacciones, nuestros representantes de soporte dedicados están a solo un clic o llamada de distancia.
        <br/>
        Nota: Es importante familiarizarse con nuestros términos y condiciones con respecto a los depósitos y retiros, incluidas las tarifas aplicables o los límites de transacción mínimos/máximos. Estos detalles se pueden encontrar en nuestro sitio web o contactando a nuestro equipo de soporte.',
