...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT4_MAC') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT4_MAC') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT4_MAC') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT4_MAC') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT4_MAC') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT4_MAC') }}">
@endsection
@section('content')
    <style>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">
                            {{ __('platforms.EXPERIENCE_THE_MT4_MAC') }}</h3>
                        <p class="col-12 text-dark-cust text-center">{{ __('platforms.EXPERIENCE_THE_FULL_POWER_MAC') }}
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">
                            {{ __('platforms.ACCESS_YOUR_ACCOUNT_MAC') }}</h3>
                    </div>

                    <div class="row">
                        <div class="col-sm-6 col-10 align-items-center d-flex">
                            <ol>
                                <li class="text-dark-cust mb-3">{{ __('platforms.OPEN_META_TRADER_DMG') }}</li>
                                <li class="text-dark-cust mb-3">{{ __('platforms.GO_TO_APPLICATIONS_FOLDER') }}</li>
                                <li class="text-dark-cust mb-3">{{ __('platforms.RIGHT_CLICK_ACCOUNTS_MT4') }}</li>
                                <li class="text-dark-cust mb-3">{{ __('platforms.TYPE_XS_FINTECH') }}</li>
                                <li class="text-dark-cust mb-3">{{ __('platforms.CLICK_NEXT_CONNECT_ACCOUNT') }}</li>
                                <li class="text-dark-cust mb-3">{{ __('platforms.ENTER_LOGIN_PASSWORD_SERVER') }}</li>
                                <li class="text-dark-cust mb-3">{{ __('platforms.CLICK_FINISH_START_TRADING') }}</li>
    ...
    <section>
        <div class="container">
            <div class="row">
                <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT4_MAC_FEATURES') }}</h3>
            </div>
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.NATIVE_MAC_APP') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
