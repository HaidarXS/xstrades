...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT4_WEB') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT4_WEB') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT4_WEB') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT4_WEB') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT4_WEB') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT4_WEB') }}">
@endsection
@section('content')
    <style>
        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">{{ __('platforms.TRADE_EASE_MT4') }}
                        </h3>
                        <p class="col-12 text-dark-cust text-center">{!! __('platforms.ACCESS_GLOBAL_MT4') !!}</p>
                    </div>
                </div>
                <div class="row mx-auto justify-content-center">
                    <div class="pt-4 d-flex justify-content-center">
                        <a href="{{ route('webtrader-checked', ['lang' => App::getLocale(), 'platform' => 'mt4']) }}"
                            class="btn join-us-button py-3 px-5 fw-700">
                            <div class="d-flex align-items-center justify-content-center">
                                <span class="me-3"><img class="btn-icon" src="{{ asset('/svgs/download-ic.svg') }}"
                                        alt="{{ __('platforms.MT4_DOWLOAD_WEB') }}"
                                        style="width: 30px; object-fit: contain;">
                                </span>
                                <span>
                                    {{ __('platforms.MT4_DOWLOAD_WEB') }}
                                </span>
                            </div>
                        </a>
                    </div>
    ...
    <section class="bg-gray">
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">{{ __('platforms.ACCESS_WEB') }}
                        </h3>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-10 align-items-center d-flex">
                            <ol>
                                <li class="text-dark-cust mb-3">{{ __('platforms.LAUNCH_MT4_WEB_PLATFORM') }}</li>
                                ...
                                <li class="text-dark-cust mb-3">{{ __('platforms.ENTER_XS_CREDENTIALS_SERVER') }}</li>
                        ...
                        <div class="col-sm-6 col-10 col-sm-6 col-10 m-sm-0 m-auto">
                            <img src="{{ asset('/img/Group 3777.png') }}" class="img-fluid h-100" alt="xs account">
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container">
            <div class="row">
                <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT4_WEB_FEATURES') }}</h3>
            </div>
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.EASY_ACCESS_ANY_BROWSER') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.REAL_TIME_PRICE_QUOTES_CHARTING') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.SIMPLICITY_MOBILITY') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.SEAMLESS_SYNCHRONIZATION') }}</p>
                </div>
            </div>
