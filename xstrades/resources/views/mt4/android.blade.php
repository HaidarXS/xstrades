...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT4_ANDROID') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT4_ANDROID') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT4_ANDROID') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT4_ANDROID') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT4_ANDROID') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT4_ANDROID') }}">
@endsection
@section('content')
    <style>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">
                            {{ __('platforms.TRADE_ON_THE_GO_TITLE_ANDROID') }}</h3>
                        <p class="col-12 text-dark-cust text-center">{!! __('platforms.TRADE_ON_THE_GO_CONTENT_ANDROID') !!}
                        </p>
                    </div>
                </div>
                <div class="row mx-auto justify-content-center">
                    <div class="pt-4 d-flex justify-content-center">
                        <a href="https://download.mql5.com/cdn/mobile/mt4/android?server=XSFintech-Demo,XSFintech-Real1"
                            target="_blank" class="btn join-us-button py-3 px-5 fw-700">
                            <div class="d-flex align-items-center justify-content-center">
                                <span class="me-3"><img class="btn-icon" src="{{ asset('/svgs/download-ic.svg') }}"
                                        alt="{{ __('platforms.MT4_DOWLOAD_ANDROID') }}"
                                        style="width: 30px; object-fit: contain;">
                                </span>
                                <span>
                                    {{ __('platforms.MT4_DOWLOAD_ANDROID') }}
                                </span>
                            </div>
                        </a>
                    </div>
    ...
    <section class="bg-gray">
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="m-auto col-7 text-center text-navy text-capitalize my-3">
                            {{ __('platforms.ACCESS_YOUR_TRADING_ACCOUNT_TITLE_ANDROID') }}</h3>
                    </div>

                    <div class="row">
                        <div class="col-sm-6 col-10 align-items-center d-flex">
                            <ol>
                                <li class="text-dark-cust mb-3">{{ __('platforms.INSTALL_ANDROID_APP') }}</li>
                        ...
                        <div class="col-sm-6 col-10 col-sm-6 col-10 m-sm-0 m-auto">
                            <img src="{{ asset('/img/android-phone.png') }}" class="img-fluid h-100" alt="xs account">
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container">
            <div class="row">
                <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT4_ANDROID_APP_FEATURES_TITLE') }}
                </h3>
            </div>
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.TRADE_ON_ANDROID_DEVICES') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.EASY_TO_USE_INTERFACE') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.LIVE_STREAMING_QUOTES_CHARTS') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.QUICK_ORDER_EXECUTION_MANAGEMENT') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.SEAMLESS_SYNCHRONIZATION_MAC') }}</p>
                </div>
            </div>
