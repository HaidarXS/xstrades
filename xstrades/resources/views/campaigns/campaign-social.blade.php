    ...
    <!-- End Google Tag Manager (noscript) -->
        ...
        <div class="custom-container p-3" style="background:white;border-radius:10px;">
            ...
            <form action="{{ route('create.lead') }}" method="POST" id="register-form">
                <div class="row my-4">
                    <div class="col-12">
                        <input type="text" class="form-control" name="firstName" placeholder="الإسم الأول (الرجاء استخدام الأحرف اللاتينية والمسافات والشرطات فقط)" required>
                    </div>
                </div>
                <input type="hidden" class="form-control" name="middleName" placeholder="">
                <div class="row my-4">
                    <div class="col-12">
                        <input type="text" class="form-control" name="lastName" placeholder="الإسم الأخير (الرجاء استخدام الأحرف اللاتينية والمسافات والشرطات فقط)" required>
                    </div>
                </div>
                <div class="row my-4">
                    <div class="col-12">
                        <input class="form-control" id="phone" type="tel" dir="rtl" name="phone" placeholder="رقم الهاتف (الرجاء استخدام الأرقام فقط)" required>
                    </div>
                </div>
                <div class="row my-4">
                    <div class="col-12">
                ...
                <input type="hidden" name="marketingTag" value="Mena Webinar Social">
                <input type="hidden" name="country_code" id="country_code">
                <div class="row my-4">
