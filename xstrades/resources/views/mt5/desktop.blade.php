...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT5_DESKTOP') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT5_DESKTOP') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT5_DESKTOP') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT5_DESKTOP') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT5_DESKTOP') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT5_DESKTOP') }}">
@endsection
@section('content')
    <style>
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.THE_FULL_POWER_MT5') }}</h3>
                                <p class="col-12 text-dark-cust text-center">
                                    {!! __('platforms.EXPERIENCE_MT5_ON_DESKTOP') !!}</p>
                            </div>
                        </div>
                        <div class="row mx-auto justify-content-center">
                            <div class="pt-4 d-flex justify-content-center">
                                <a href="https://download.mql5.com/cdn/web/XS Trades.fintech.ltd/mt5/xsfintech5setup.exe"
                                    target="_blank" class="btn join-us-button py-3 px-5 fw-700">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="me-3"><img class="btn-icon"
                                                src="{{ asset('/svgs/download-ic.svg') }}"
                                                alt="{{ __('platforms.MT5_DOWLOAD_DESKTOP') }}"
                                                style="width: 30px; object-fit: contain;">
                                        </span>
                                        <span>
                                            {{ __('platforms.MT5_DOWLOAD_DESKTOP') }}
                                        </span>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="container">
                    <div class="row py-5">
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.ACCESS_MT5_DESKTOP') }}</h3>
                            </div>

                            <div class="row">
                                <div class="col-sm-6 col-10 align-items-center d-flex">
                                    <ol>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.DOWNLOAD_INSTALL_MT5') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.LAUNCH_MT5_FILE_MENU') }}</li>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT5_DESKTOP_FEATURES') }}</h3>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.POWERFUL_PLATFORM') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.ADVANCED_CHARTING_TOOLS') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.ECONOMIC_CALENDAR_NEWS_UPDATES') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.BUILT_IN_MQL5_PROGRAMMING') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
