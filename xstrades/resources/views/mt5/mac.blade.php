...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT5_MAC') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT5_MAC') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT5_MAC') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT5_MAC') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT5_MAC') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT5_MAC') }}">
@endsection
@section('content')
    <style>
        ...
        <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-mac', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
                        <svg fill="#30af85" height="100" width="100" class="platforms"
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.EXPERIENCE_MT5_WITH_MAC') }}</h3>
                                <p class="col-12 text-dark-cust text-center">
                                    {{ __('platforms.EXPERIENCE_MT5_MAC_CONTENT') }}</p>
                            </div>
                        </div>
                        <div class="row mx-auto justify-content-center">
                            <div class="pt-4 d-flex justify-content-center">
                                <a href="https://my.XSTrades.com/{{ getCorrectLangSlug() }}register/?sl=1"?sl=1 target="_blank"
                ...
                <div class="container">
                    <div class="row py-5">
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.ACCESS_YOUR_TRADING_ACCOUNT_MAC') }}</h3>
                            </div>

                            <div class="row">
                                <div class="col-sm-6 col-10 align-items-center d-flex">
                                    <ol>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.OPEN_META_TRADER_DMG_MT5') }}
                                        </li>
                                        <li class="text-dark-cust mb-3">
                                            {{ __('platforms.GO_TO_APPLICATIONS_FOLDER_MT5') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.RIGHT_CLICK_ACCOUNTS') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.TYPE_XS_FINTECH') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.CLICK_NEXT_CONNECT_ACCOUNT') }}
                                        </li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.ENTER_LOGIN_PASSWORD_SERVER') }}
                                        </li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.CLICK_FINISH_START_TRADING') }}
                                        </li>
                                ...
                                <div class="col-sm-6 col-10 col-sm-6 col-10 m-sm-0 m-auto">
                                    <img src="{{ asset('/img/91374.png') }}" class="img-fluid h-100" alt="xs account">
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT5_MAC_FEATURES_TITLE') }}
                        </h3>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.NATIVE_MAC_APP_MT5') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.OPTIMIZED_MAC_ENVIRONMENT') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.ACCESS_WIDE_RANGE_INSTRUMENTS') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.FULL_TRADING_CAPABILITIES') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
