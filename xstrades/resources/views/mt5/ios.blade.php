...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT5_IOS') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT5_IOS') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT5_IOS') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT5_IOS') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT5_IOS') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT5_IOS') }}">
@endsection
@section('content')
    <style>
        ...
        <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-ios', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
                        <svg fill="#30af85" height="100" width="100" version="1.1" class="platforms"
                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 149.59 137.46"
                            style="enable-background:new 0 0 149.59 137.46;">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.TRADE_ON_THE_GO_TITLE_MT5') }}</h3>
                                <p class="col-12 text-dark-cust text-center">
                                    {{ __('platforms.TRADE_ON_THE_GO_CONTENT_IOS_MT5') }}
                                </p>
                            </div>
                        </div>
                        <div class="row mx-auto justify-content-center">
                            <div class="pt-4 d-flex justify-content-center">
                                <a href="https://download.mql5.com/cdn/mobile/mt5/ios?server=XSFintech-REAL-1"
                                    target="_blank" class="btn join-us-button py-3 px-5 fw-700">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="me-3"><img class="btn-icon"
                                                src="{{ asset('/svgs/download-ic.svg') }}"
                                                alt=" {{ __('platforms.MT5_DOWLOAD_IOS') }}"
                                                style="width: 30px; object-fit: contain;">
                                        </span>
                                        <span>
                                            {{ __('platforms.MT5_DOWLOAD_IOS') }}
                                        </span>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="container">
                    <div class="row py-5">
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.ACCESS_YOUR_TRADING_ACCOUNT_TITLE_MT5_IOS') }}</h3>
                            </div>

                            <div class="row">
                                <div class="col-sm-6 col-10 align-items-center d-flex">
                                    <ol>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.INSTALL_APPLE_APP_IOS') }}</li>
                                ...
                                <div class="col-sm-6 col-10 col-sm-6 col-10 m-sm-0 m-auto">
                                    <img src="{{ asset('/img/iphone.png') }}" class="img-fluid h-100" alt="xs account">
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT5_IOS_FEATURES_TITLE') }}
                        </h3>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_1') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_2') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_3') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_4') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_5') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_6') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
