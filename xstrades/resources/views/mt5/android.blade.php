...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT5_ANDROID') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT5_ANDROID') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT5_ANDROID') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT5_ANDROID') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT5_ANDROID') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT5_ANDROID') }}">
@endsection
@section('content')
    <style>
        @media (max-width: 768px) {
            .metatrader-mt5-banner {
                background-position: center;
                background-size: cover;
                background-repeat: no-repeat;
                background-image: url(/img/Platform/mt5-mobile.webp);
            }
        }
    ...
    @include('layouts.banner', [
        'bannerTitle' => __('platforms.PAGE_TITLE_MT5'),
        'bannerDescription' => __('platforms.PAGE_DESC_MT5'),
        'bannerImage' => '/img/Platform/mt5.svg?v1.2',
        'mobileBanner' => '/img/Platform/mt5-mobile.webp',
    ])

    {{-- <section class="metatrader-mt5-banner p-3">
    ...
    <div
        ...
        <h1 class="text-white fw-700">{!! __('platforms.PAGE_TITLE_MT5') !!}</h1>
        <p class="text-white my-4 ">{!! __('platforms.PAGE_DESC_MT5') !!}</p>
    ...
    <div class="col-md-6 col-12 d-none d-md-block text-end">
        <img src="{{ asset('img/Platform/mt5.svg') }}" class="metatrader-banner-img"
    ...
    <div class="container py-4 tabs-container">
        ...
        <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-desktop', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
                        <svg fill="#dadada" height="100" width="100" class="platforms" x="0px" y="0px"
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-web', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-mac', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-ios', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-android', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
                        <svg fill="#30af85" height="100" width="100" class="platforms" data-name="Layer 1"
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.TRADE_ON_THE_GO_TITLE_MT5_ANDROID') }}</h3>
                                <p class="col-12 text-dark-cust text-center">
                                    {{ __('platforms.TRADE_ON_THE_GO_CONTENT_ANDROID_MT5') }}</p>
                            </div>
                        </div>
                        <div class="row mx-auto justify-content-center">
                            <div class="pt-4 d-flex justify-content-center">
                                <a href="https://download.mql5.com/cdn/mobile/mt5/android?server=XSFintech-REAL-1"
                                    target="_blank" class="btn join-us-button py-3 px-5 fw-700">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="me-3"><img class="btn-icon"
                                                src="{{ asset('/svgs/download-ic.svg') }}"
                                                alt="{{ __('platforms.MT5_DOWLOAD_ANDROID') }}"
                                                style="width: 30px; object-fit: contain;">
                                        </span>
                                        <span>
                                            {{ __('platforms.MT5_DOWLOAD_ANDROID') }}
                                        </span>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="container">
                    <div class="row py-5">
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.ACCESS_YOUR_TRADING_ACCOUNT_TITLE_ANDROID_MT5') }}</h3>
                            </div>

                            <div class="row">
                                <div class="col-sm-6 col-10 align-items-center d-flex">
                                    <ol>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.INSTALL_ANDROID_APP_MT5') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.LOGIN_EXISTING_ACCOUNT') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.SELECT_SERVER') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.ENTER_LOGIN_PASSWORD') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.CLICK_LOGIN_START_TRADING') }}
                                        </li>

                                    </ol>
                                </div>

                                <div class="col-sm-6 col-10 col-sm-6 col-10 m-sm-0 m-auto">
                                    <img src="{{ asset('/img/android-phone.png') }}" class="img-fluid h-100"
                                        alt="xs account">
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <h3 class="col-12 text-navy text-capitalize my-3">
                            {{ __('platforms.MT5_ANDROID_FEATURES_TITLE') }}</h3>
                    </div>
                    <div class="row">
                        <div
                            class="col-sm-auto col-2 d-flex flex-wrap justify-content-center align-content-center pe-0 mb-2">
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.ANDROID_APP_TRADE_ON_SMARTPHONES_TABLETS') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.LIVE_STREAMING_QUOTES_CUSTOMIZABLE_CHARTS') }}
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">
                                {{ __('platforms.FULL_TRADING_FUNCTIONALITY_ACCESS_INSTRUMENTS') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.REAL_TIME_ORDER_EXECUTION_MANAGEMENT') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">
                                {{ __('platforms.SECURE_ENCRYPTED_TRANSMISSION_PROTECT_USER_INFO') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MULTIPLE_ORDER_TYPES') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.MT5_IOS_FEATURE_7') }}</p>
                        </div>
                    </div>
