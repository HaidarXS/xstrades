<?php 
    return [
        'TRADING_CONDITIONS_TITLE1' => 'Libere todo el potencial de sus operaciones',

        'TRADING_CONDITIONS_DESCRIPTION1' => 'Nuestras condiciones comerciales premium y competitivas están diseñadas para adaptarse a su estilo y preferencias comerciales.
        <br/>
        Con nuestras condiciones comerciales, tendrá todo lo que necesita para tener éxito en los mercados financieros y disfrutar de la mejor experiencia comercial de la industria.',
        
        'MARGIN_LEVERAGE' => 'Margen y apalancamiento',
        'SPREADS' => 'diferenciales',
        'SWAP_RATES' => 'Tasas de swap',
        'TRADING_HOURS' => 'Los horarios comerciales',
        'EXECUTION' => 'Ejecución',
        'SWAP_FREE_RULES' => 'Intercambiar reglas gratuitas',

        'TRADING_CONDITIONS_TITLE2' => 'Especificaciones del contrato',
