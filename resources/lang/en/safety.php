<?php
    return [
        ...
        "PAGE_DESCRIPTION" => "At XSTrades.com, we prioritize the security and safety of clients’ funds by continually investing in our infrastructure and implementing advanced security protocols to maintain the highest security standards and safeguard these funds. We partner with the most reputable financial institutions around the world and implement client funds segregation to ensure that our clients’ funds are safe, secure, and protected at all times",
       
        "SECTION_1_TITLE" => "Enhanced Insurance Up To $5,000,000",
        "SECTION_1_DESCRIPTION" => "XS Trades provides clients with additional insurance protection to cover losses in excess of USD 10,000 and up to USD 5,000,000 against claims against omission, fraud, negligence and other risks that may lead to the financial loss of clients, at no direct cost to clients. This Civil Liability Insurance Program is underwritten by Lloyd's of London and ensures that all clients and third parties working with XS Trades have the protection they need. ",
        ...
        "SECTION_3_DESCRIPTION" => "XS Trades Group is a multinational fintech and financial services provider with entities regulated and authorized in various jurisdictions around the globe. We are constantly striving to be compliant with the strictest international regulatory guidelines.",
        "SECTION_3_BUTTON_TEXT" => "Regulation",
 
        "SECTION_4_TITLE" => "Security Standards",
        "SECTION_4_DESCRIPTION" => "At XSTrades.com, we have invested heavily in our infrastructure and implemented advanced security protocols to ensure that our systems comply with the most stringent global security standards.",
        "SECTION_4_BUTTON_TEXT" => "Security",
 
        "SECTION_5_TITLE" => "Success Story",
        "SECTION_5_DESCRIPTION" => "Since 2010, the XS Trades Group has been providing traders, institutional investors, and brokers worldwide with access to deep institutional liquidity and advanced trading technology, combined with an efficient user experience, high-quality relationship management, and excellent customer support.",
