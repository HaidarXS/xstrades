...
return [
    ...
    'BANNER_TITLE' => 'Metals Trading',
    'BANNER_DESCRIPTION' => 'Unlock the Full Potential of Metal Trading with the Best Global Multi-Asset Broker.',


    "SECTION_1_TITLE" => 'TRADE METALS WITH THE BEST ONLINE TRADING PLATFORM',
    ...
    "FAQ_1_Q" => "What is the Metals Market?",
    "FAQ_1_A" => "The metals market is a global marketplace for trading various types of metals like precious metals and base metals to speculate on the price of these highly volatile instruments without buying the underlying asset.",

    "FAQ_2_Q" => "What is Metals Trading?",
    "FAQ_2_A" => "Trading metals involves the buying and selling of various precious metals like gold, silver, platinum, and palladium or base metals such as copper and aluminum. Each metal has its unique characteristics and market dynamics.",

    "FAQ_3_Q" => "What are Safe-Haven Assets in Metal Trading?",
    "FAQ_3_A" => "Precious metals like gold and silver are often considered safe-haven assets, as they tend to retain their value during times of market uncertainty. Traders often turn to these metals as a hedge against inflation and economic volatility.",

    "FAQ_4_Q" => "What are Base Metals?",
    "FAQ_4_A" => "Base metals such as copper and aluminum are essential for various industries, including construction, electronics, and manufacturing. Trading these metals provides exposure to the global industrial sector and allows traders to capitalize on market trends and demand fluctuations.",

    "FAQ_5_Q" => "What are Metal Markets Dynamics?",
    "FAQ_5_A" => "Metals prices are influenced by supply and demand factors, including production levels, geopolitical events, economic indicators, and market sentiment. Understanding these dynamics is crucial for informed decision-making in metals trading.",
];