<?php
    return [
        ...
        "SECTION_1_DESC" => "Discover the limitless potential of futures trading by trading OTC Futures (CFDs on Futures) with the Global Multi-Asset Broker. <br/><br/> Transcend the limitations of traditional futures trading and embrace the unparalleled opportunities offered by XS.com.",
        "SECTION_2_TITLE" => "TRADING OTC FUTURES WITH XS",
        "SECTION_2_DESC" => "Trading OTC Futures (CFDs on Futures) with XS, an award-winning multi-asset broker, presents numerous advantages. XS grants access to diverse markets, enabling traders to engage in various futures contracts spanning commodities, currencies, indices, and more. <br/><br/>  With a comprehensive range of assets available through XS platforms, traders can diversify portfolios, effectively manage risks, and seize multiple market opportunities. Additionally, XS offers advanced trading tools and competitive pricing, enhancing investors' overall futures trading experience.",
        ...
        <br/>
        Trading OTC Futures (CFDs on Futures) with XS, an award-winning multi-asset broker, presents numerous advantages.",
        ...
        'DESCRIPTION_1' => 'Welcome to the world of futures trading with XS. Discover the limitless potential of futures trading by trading OTC Futures (CFDs on Futures) with the best CFD broker. Transcend the limitations of traditional futures trading and embrace the unparalleled opportunities offered by XS.
        Trading OTC Futures (CFDs on Futures) with XS presents numerous advantages. XS grants access to diverse markets, enabling traders to engage in various futures contracts spanning commodities, currencies, indices, and more.
        <br><br>
        With a comprehensive range of assets available through XS platforms, traders can diversify portfolios, effectively manage risks, and seize multiple market opportunities. ',
    
        'DESCRIPTION_2' => 'XS offers access to a wide range of OTC Futures (CFDs on Futures), including Crude Oil, Natural Gas, Indices & Gold. Plan your futures trades with confidence and optimize your trading experience by utilizing our detailed contract specifications. Explore our comprehensive contract specifications and gain a deeper understanding of our exceptional trading conditions including contract size, leverage, spreads, commissions, swaps, and more for different account types.',
    
    
        "TRADING_CONDITION_1_TITLE" => "Normal Trading Hours",
        "TRADING_CONDITION_1_DESCRIPTION" => "Normal trading hours refer to the regular trading sessions available for trading. The below shows the normal trading hours for futures available for trading with XS.
        <br>
        ...
        "TRADING_CONDITION_2_DESCRIPTION" => "XS.com offers a floating spread on all futures for all account types. Hence the spreads in the contract specifications table are the average spread based on the previous trading day. For live spreads, please refer to the trading platform. Please note that spreads may widen when the markets experience lower liquidity, including rollover time.",
