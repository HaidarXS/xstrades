...
return [
    ...
    'TRADE_GLOBAL_MULTI_ASSET_DISC'=>'Explore the world of online trading with XS, where you can trade the largest global financial markets and access 1000+ trading instruments and multiple asset classes from one single account.<br/> 
    ...
    'WHY_TRADE_CDF'=>'Why Trade CFDs With XS?',
    'WHY_TRADE_CDF_DISC'=>'Discover the advantages of trading CFDs with XS. Enjoy an optimised trading experience',
    'LEVERAGE_AND_FLEXIBILITY'=>'Leverage and Flexibility',
    'LEVERAGE_AND_FLEXIBILITY_DISC'=>'Maximize your trading potential with XS. Benefit from leverage, allowing you to amplify market exposure with smaller investments. Enjoy increased flexibility in your trading strategies.',
    'LONG_AND_SHORT'=>'Long and Short',
    'LONG_AND_SHORT_DISC'=>'Go beyond traditional buying and selling. XS enables you to benefit from both rising and falling markets. Take advantage of bullish trends by going long or capitalise on bearish trends by going short.',
    'FRACTIONAL_TRADING'=>'Fractional Trading',
    'FRACTIONAL_TRADING_DISC'=>'Diversify your portfolio without limitations. XS offers fractional trading, enabling you to invest in multiple asset classes with smaller budgets. Expand your market participation and enhance portfolio diversification.',

    //Metals page
    'METALS_DESC' => 'Discover the vast possibilities of metals trading with XS, where you can trade CFDs on gold, silver, platinum, palladium and other metals with an award-winning broker. XS offers a seamless platform for exploring spot metals trading, allowing you to capitalize on new trading opportunities.',
    'UNLOCK_THE_POTENTIAL' => 'unlock the potential of metals trading with xs',
    'UNLOCK_THE_POTENTIAL_DESC' => 'Unleash the Power of Trading the world&#39;s leading stock indices, and Trade International Stock Indices with XS. Gain Access to Global Markets and Seamlessly Buy and Sell Leading stock indices such as Dow Jones, Dax, Nasdaq, and More <br/>Join XS.com today and unleash the power of stock indices trading',
    'METALS_TRADING_WITH_XS' => 'METALS TRADING WITH XS',
    'METALS_TRADING_WITH_XS_DESC' => 'Whether you choose to trade gold CFDs, silver CFDs, platinum CFDs, or palladium CFDs, XS provides you with access to both precious metals and base metals, enabling you to diversify your portfolio and hedge against inflation.<br/> Benefit from the low or negative correlation metals have with other asset classes, reducing volatility and risk.',
    'UNDERSTADING_METALS' => 'Understanding Metals Trading: An Overview with XS',
    'UNDERSTADING_METALS_DESC_1' => 'Metals trading involves the buying and selling of various precious and base metals, providing investors with exposure to this specific asset class. Here &apos; s an overview of metals trading with XS:',
    'UNDERSTADING_METALS_DESC_2' => 'Diverse Range of Metals: XS offers access to a diverse selection of metals, including precious metals like gold, silver, platinum, and palladium, as well as base metals such as copper and aluminum. Each metal has its unique characteristics and market dynamics.',
    ...
    'ENERGIZE_YOUR_TRADING_DESC' => 'Power up your trading journey with XS as you explore the exciting energy markets. Trade a variety of energy commodities, including crude oil, natural gas, and more, and seize opportunities driven by global supply and demand dynamics, geopolitical events, and technological advancements.',
    'ENERGY_TRADING_WITH_XS' => 'ENERGY TRADING WITH XS',
    'ENERGY_TRADING_WITH_XS_DESC' => 'With XS, you can enjoy our advantageous trading environment, featuring competitive pricing, tight spreads, and efficient execution. Take advantage of our state-of-the-art MetaTrader 4 and MetaTrader 5 trading platforms, accessible across multiple devices, ensuring a seamless trading experience.',
    ...
    'UNDERSTANDING_ENERGIES_DESC_5' => 'Access to Energy Markets with XS<br/> XS provides a comprehensive trading platforms that offer access to energy markets and a wide range of energy commodities. With real-time market data, advanced trading tools, and competitive pricing, XS empowers traders to make informed decisions and execute trades efficiently. Our platform ensures reliable execution and supports traders in maximizing their potential returns while managing risk effectively.',
    ...
    'JOIN_THE_DIGITAL_REVOLUTION_DESC' => 'Discover the world of cryptocurrencies and unlock the potential of digital assets with XS. Trade popular cryptocurrencies such as Bitcoin, Ethereum, Litecoin, and more, and seize opportunities in the rapidly evolving cryptocurrency market.<br/> Join XS.com today and embark on your cryptocurrency trading journey.',
    'CRYPTOCURRENCY_TRADING_WITH_XS' => 'CRYPTOCURRENCY TRADING WITH XS',
    'CRYPTOCURRENCY_TRADING_WITH_XS_DESC' => 'Experience the excitement of cryptocurrency trading with XS.com. Our platforms offer seamless trading of a wide range of cryptocurrencies, allowing you to take advantage of market volatility and potential price movements. Benefit from our advanced trading tools, secure storage solutions, and reliable execution to trade cryptocurrencies with confidence',
    ...
    'EXPERIENCE_THE_WORLD_OF_COMMODITIES_DESC' => 'Embark on an exciting journey into commodities trading with XS. Our platforms offer a diverse range of CFD instruments encompassing various commodities. Commodities trading provides a unique opportunity to participate in the global markets, with the potential for favorable returns',
    'COMMODITIES_TRADING_WITH_XS' => 'COMMODITIES TRADING WITH XS',
    'COMMODITIES_TRADING_WITH_XS_DESC' => 'With XS, you can enjoy our advantageous trading environment, featuring competitive pricing, tight spreads, and efficient execution. Take advantage of our state-of-the-art MetaTrader 4 and MetaTrader 5 trading platforms, accessible across multiple devices, ensuring a seamless trading experience.',
    'UNDERSTANDING_COMMODITIES' => 'Commodities Overview: Discover the World of Commodities Trading with XS',
    'UNDERSTANDING_COMMODITIES_DESC_1' => 'Introduction<br/>Welcome to the world of commodities trading with XS. Commodities represent tangible goods that are vital to our daily lives, such as metals, energy resources, agricultural products, and more. In this overview, we will explore the key aspects of commodities trading, including popular commodities, market dynamics, and the advantages of trading commodities with XS.',
