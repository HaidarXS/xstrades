<?php
    return [
        ...
        "SECTION_1_BUTTON_TEXT" => "Assurance",
       
        "SECTION_2_TITLE" => "Séparation des fonds des clients",
        "SECTION_2_DESCRIPTION" => "Tous les comptes clients sont séparés des fonds de l’entreprise en étant détenus dans des comptes distincts auprès des institutions financières les plus réputées du monde.",
        "SECTION_2_BUTTON_TEXT" => "Méthodes de financement",
 
        "SECTION_3_TITLE" => "Règlements multiples",
        "SECTION_3_DESCRIPTION" => "XS Group est une multinationale de fintech et de services financiers avec des entités réglementées et autorisées dans diverses juridictions à travers le monde. Nous nous efforçons constamment de respecter les directives réglementaires internationales les plus strictes.",
        ...
        "SECTION_5_DESCRIPTION" => "Depuis 2010, le groupe XS fournit aux traders, aux investisseurs institutionnels et aux courtiers du monde entier un accès à une liquidité institutionnelle profonde et à une technologie de trading avancée, combinée à une expérience utilisateur efficace, à une gestion des relations de haute qualité, et un excellent support client.",
        "SECTION_5_BUTTON_TEXT" => "Histoire",
    ];