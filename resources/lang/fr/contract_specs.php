<?php
return [
    'CONTRACT_SPECIFICATIONS' => 'Sélectionnez le type de compte',
    'CONTRACT_SPECIFICATIONS_DESCRIPTION' => 'Accédez aux marchés mondiaux et négociez un large éventail de classes d\'actifs dans les meilleures conditions de trading. Planifiez vos transactions en toute confiance et optimisez votre expérience de trading en utilisant nos spécifications contractuelles détaillées. Explorez nos spécifications complètes de contrats et obtenez une compréhension plus approfondie de nos conditions de négociation exceptionnelles, notamment la taille des contrats, les options de levier, les heures de négociation, les exigences de marge, etc. En vous familiarisant avec ces spécifications, vous pouvez prendre des décisions de trading éclairées et gérer efficacement vos positions. ',
    ...
    'CURRENCY' => 'Currency',
    'CASH' => 'CASH',
    'CONTRACT_SIZE' => 'Taille du contrat',
    ...
    'SELECT_ASSET' => "Sélectionnez la catégorie d’actif.",
    'SELECT_ACCOUNT' => "Sélectionnez le type de compte",
    'PLATFORM_FILTER' => "Sélectionner la plateforme de Trading",
    ...
    Accédez aux marchés mondiaux et tradez une large gamme de classes d\'actifs avec les meilleures conditions de trading.
    <br><br>
    Planifiez vos transactions en toute confiance et optimisez votre expérience de trading en utilisant nos spécifications de contrat détaillées.
    <br><br>
    Explorez nos spécifications de contrat complètes et approfondissez votre compréhension de nos conditions de trading exceptionnelles, notamment la taille du contrat, levier, les spreads, les commissions, les swaps, et bien plus encore, pour différents types de comptes.
    <br><br>
    ...
    "STOP_LEVEL_TITLE" => "Niveau d’arrêt.",
    "STOP_LEVEL_DESCRIPTION" => "Le niveau d’arrêt est la distance minimale (différence en pips) entre le prix du marché actuel et le prix de l’ordre en attente.
        Les valeurs de niveau stop dans le tableau des spécifications du contrat sont sujettes à changement et peuvent ne pas être disponibles pour les traders utilisant certaines stratégies de trading à haute fréquence ou Expert Advisors.
    ",
