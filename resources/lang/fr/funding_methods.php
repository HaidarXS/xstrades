...
return [
    ...
    'MAX_DEPOSIT' => 'DÉPÔT MAXIMAL ',
    'PROCESSING_TIME' => 'TEMPS DE TRAITEMENT ',
    'ACCEPTED_CURRENCIES' => 'DEVISES ACCEPTÉES ',

    'BANK_TRANSFER' => 'Virement bancaire ',
    'VISA_MASTERCARD' => ' Visa et MasterCard ',
    'SKRILL' => 'Skrill',
    'NETELLER' => 'Neteller',
    'KLARNA' => 'Klarna',
    'GIROPAY' => 'Giropay',
    ...
    'SECURITY_TITLE' => 'Sécurité et sûreté des fonds',
    'SECURITY_DESCRIPTION' => 'Nous accordons la priorité à la sécurité et à la sûreté des fonds dans nos processus de dépôt et de retrait et utilisons des protocoles de cryptage robustes pour protéger vos informations financières. Nous prenons toutes les mesures nécessaires et appropriées pour protéger nos clients et garantir que toutes les réglementations AML sont strictement respectées. XS n\'accepte pas les dépôts ou les demandes de retrait de tiers. Bénéficiez de transactions transparentes, de retraits rapides et d\'une assistance fiable pendant que vous gérez vos fonds avec XS Rejoignez XS aujourd\'hui et profitez de la facilité et de l\'efficacité du dépôt et du retrait de fonds et du trading avec un leader mondial du marché.',

    'SUPPORT_TITLE' => 'Assistance client haut de gamme',
    'SUPPORT_DESCRIPTION' => 'Notre équipe de support client est disponible pour vous aider tout au long du processus de dépôt et de retrait. Si vous rencontrez des problèmes ou avez des questions concernant vos transactions, nos représentants d\'assistance dédiés sont à portée de clic ou d\'appel. Remarque : Il est important de vous familiariser avec nos conditions générales concernant les dépôts et les retraits, y compris les frais applicables ou les limites de transaction minimales/maximales. Ces détails peuvent être trouvés sur notre site Web ou en contactant notre équipe d\'assistance.',

    'MIN_WITHDRAWAL'=>'Retrait ',
    'MAX_WITHDRAWAL'=>' Retrait maximal '
];