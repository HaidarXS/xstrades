<?php
return [
    'PAGE_BANNER_TITLE' => 'Mastercard XS & Application Mobile',

    'EASY_AND_FAST' => 'Accès facile et rapide à vos fonds de n’importe où.',
    'WHAT_IS_XS_PREPAID'=>'Qu\'est-ce que la  XS Mastercard prépayée ?',
    ...
    <br/><br/>
    La carte Mastercard prépayée XS peut être utilisée pour les points de vente, les guichets automatiques, le commerce électronique, les applications mobiles et les solutions de fidélisation.',

    'XS_PREPAID_MASTERCARD' => 'Carte Mastercard XS prépayée',

    'XS_PREPAID_MASTERCARD_DESC' => 'La XS Prépayée Mastercard permet aux traders et aux partenaires de transférer des fonds de leur portefeuille XS dans le portail client XS vers leur carte directement, et vice versa.
    <br/><br/>
    La XS Prépayée Mastercard peut être utilisée en ligne et hors ligne (POS, distributeurs automatiques, paiements en ligne, applications mobiles et programmes de fidélité).
    <br/><br/>
    La XS Mastercard est émise en USD et offre des fonctionnalités exclusives, ainsi qu’une gamme d’avantages et de réductions.',
    ...
    'APPLY_FOR_YOUR_XS_MASTER_CARD' => 'Demandez votre  XS Mastercard',
