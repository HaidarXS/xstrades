<?php
return [
    'HOLIDAYS_HOURS_TITLE' => 'Operação em Feriados',
    'HOLIDAYS_HOURS_DESC' => '
    ...
    'UPCOMING_DESC' => 'Não há feriados próximos',

    'NOTICES_HOURS_TITLE' => 'Avisos sobre o Mercado',
    'NOTICES_HOURS_DESC' => '
    As condições normais de negociação podem ser afetadas por alguns fatores sazonais e de mercado. A seção abaixo mostra as últimas atualizações sobre os próximos eventos e seu efeito nas condições de negociação.
    <br/><br/>
    Todos os horários nas tabelas abaixo estão no horário do servidor (GMT+3)',
    
    'UPCOMING_NOTICES_TITLE' => 'Próximos Avisos',
    'UPCOMING_NOTICES_DESC' => 'Não há avisos.',
];
?>