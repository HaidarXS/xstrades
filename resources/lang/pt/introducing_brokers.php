<?php 
    return [
        ...
        <br/><br/>  
        O programa inclui um gerente de relacionamento dedicado para ajudá-lo a expandir seus negócios e garantir que os clientes obtenham a melhor experiência de usuário e suporte.
        <br/><br/> 
        Além disso, você terá acesso a ferramentas avançadas de rastreamento, materiais de marketing exclusivos e conteúdo promocional, e poderá sacar seus ganhos por meio de diversas opções de pagamento flexíveis e confiáveis.',

        'LIQUIDITY_SOLUTIONS' => 'Como funciona?',
