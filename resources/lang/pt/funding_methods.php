<?php 
    return [
        ...
        'ACCEPTED_CURRENCIES' => 'MOEDAS ACEITAS',
        ...
        'UNLIMITED' => 'Ilimitado',
        'OR_EQUIVALENT' => 'ou equivalente',
        'WORKING_DAYS' => 'dia úteis',
        'INSTANT' => 'Imediato',
        'UP_TO' => 'Up to',
        ...
        'SUPPORT_DESCRIPTION' => 'Nossa equipe de suporte ao cliente está prontamente disponível para ajudá-lo durante todo o processo de depósito e retirada. Se você encontrar algum problema ou tiver dúvidas sobre suas transações, nossos representantes de suporte dedicados estão a apenas um clique ou uma ligação de distância. Nota: É importante familiarizar-se com os nossos termos e condições relativos a depósitos e levantamentos, incluindo quaisquer taxas aplicáveis ou limites mínimos/máximos de transação. Esses detalhes podem ser encontrados em nosso site ou entrando em contato com nossa equipe de suporte.',
