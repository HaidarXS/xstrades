<?php
return [
    'CONTRACT_SPECIFICATIONS' => 'Especificação de Contrato',

    'CONTRATCT_SPECS_INTRO' => 'Acesse mercados globais e opere uma ampla gama de classes de ativos com asm melhores condições de trading
    <br><br>
    Planeje suas operações com confiança e otimize sua experiência de trading utilizando nossas especificações detalhadas de contrato.
    <br><br>
    Explore nossas especificações de contrato abrangentes e obtenha um entendimento mais profundo sobre nossas condições excepcionais de trading, incluindo tamanho do contrato, alavancagem, spreads, comissões, swaps e mais para diferentes tipos de conta.
    <br><br>
    Ao se familiarizar com estas especificações, você pode tomar decisões de trading informadas e gerenciar efetivamente suas posições.',
    ...
    'SELECT_ASSET' => "Selecione a Classe de Ativos",
    'SELECT_ACCOUNT' => "Selecione o Tipo de Conta",
    'PLATFORM_FILTER' => "Selecione a Plataforma de Trading",

    'SYMBOL' => "Símbolo",
    'COMMISSIONS' => "Comissões",
    'SPREAD' => "Spreads",
    'LEVERAGE' => "Alavancagem",
    'SWAP_SHORT' => "Swap Vendido",
    'SWAP_LONG' => "Swap Comprado",
    'CONTRACT_SIZE' => "Tamanho do Contrato",
    'SEARCH' => "Buscar",
    'SEARCH_BAR' => 'Buscar...',
    'PLATFORM' => 'Platform',
    ...
    'FIXED_LEVERAGE_DESCRIPTION' => 'A XS.com oferece alavancagem fixa em algumas classes de ativos e tipos de contas. Neste caso, a alavancagem máxima exibida na tabela de especificações do contrato NÃO será alterada com base em suas posições líquidas em aberto.
        ...
        Futuros, Commodities, Ações e Criptomoedas (exceto BTC e ETH) em todos os tipos de conta.',

    'STOP_LEVEL_TITLE' => 'Nível de Stop',
    'STOP_LEVEL_DESCRIPTION' => 'O nível de stop é a distância mínima (diferença em pips) entre o preço de mercado atual e o preço da ordem pendente.
        Os valores do nível de stop na tabela de especificações do contrato estão sujeitos a alterações e podem não estar disponíveis para traders que utilizam certas estratégias de negociação de alta frequência ou Consultores Especializados (Expert Advisors).',
