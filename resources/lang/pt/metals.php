...
return [
    ...
    'BANNER_TITLE' => 'Trading de Metais',
    'BANNER_DESCRIPTION' => 'Desbloqueie o Potencial Completo do Trading de Metais com a Melhor Corretora Global Multi-Ativos.',
 
 
    "SECTION_1_TITLE" => 'NEGOCIE METAIS COM A MELHOR PLATAFORMA ONLINE DE TRADING',
    ...
    "FAQ_1_Q" => "O que é o Mercado de Metais?",
    "FAQ_1_A" => "O mercado de metais é um mercado global para a negociação de vários tipos de metais como metais preciosos e metais básicos para especular sobre o preço desses instrumentos altamente voláteis sem comprar o ativo subjacente.",
 
    "FAQ_2_Q" => "O que é o Trading de Metais?",
    "FAQ_2_A" => "Negociar metais envolve a compra e venda de vários metais preciosos como ouro, prata, platina e paládio, ou metais básicos como cobre e alumínio. Cada metal tem suas características e dinâmicas de mercado únicas.",
 
    "FAQ_3_Q" => "O que são Ativos de Refúgio no Trading de Metais?",
    "FAQ_3_A" => "Metais preciosos como ouro e prata são frequentemente considerados ativos de refúgio, pois tendem a manter seu valor em tempos de incerteza de mercado. Os traders muitas vezes recorrem a esses metais como uma proteção contra inflação e volatilidade econômica.",
 
    "FAQ_4_Q" => "O que são Metais Básicos?",
    "FAQ_4_A" => "Metais básicos como cobre e alumínio são essenciais para várias indústrias, incluindo construção, eletrônicos e manufatura. Negociar esses metais oferece exposição ao setor industrial global e permite capitalizar em tendências de mercado e flutuações de demanda.",
 
    "FAQ_5_Q" => "Quais são as Dinâmicas do Mercado de Metais?",
    "FAQ_5_A" => "Os preços dos metais são influenciados por fatores de oferta e demanda, incluindo níveis de produção, eventos geopolíticos, indicadores econômicos e sentimento de mercado. Entender essas dinâmicas é crucial para tomar decisões informadas na negociação de metais.",
