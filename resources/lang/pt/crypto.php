...
return [
    ...
    'BANNER_TITLE' => 'Trading de Criptomoedas',
    'BANNER_DESCRIPTION' => 'Junte-se à Revolução Digital e Comece a Negociar Criptomoedas com a Melhor Corretora Global Multi-Ativos.',
 
 
    "SECTION_1_TITLE" => 'NEGOCIE CRIPTOMOEDAS COM A MELHOR PLATAFORMA DE TRADING ONLINE',
    ...
    <br/><br/>
    <span class='d-flex'> Todas as Criptomoedas:  <span class='ms-auto'>24/7 exceto durante manutenção do servidor.</span></span>
    ",
    ...
    "TRADING_CONDITION_7_TITLE" => "Nível de Stop",
    "TRADING_CONDITION_7_DESCRIPTION" => "O nível de stop é a distância mínima (diferença em pips) entre o preço de mercado atual e o preço da ordem pendente. Os valores do nível de stop na tabela de especificações de contrato estão sujeitos a alterações e podem não estar disponíveis para traders que utilizam certas estratégias de negociação de alta frequência ou Expert Advisors.",
 
    "FAQ" => "FAQ",
 
    "FAQ_1_Q" => "O que são Criptomoedas?",
    "FAQ_1_A" => "Criptomoedas são moedas digitais ou virtuais que utilizam criptografia para transações seguras e controlar a criação de novas unidades.",
 
    "FAQ_2_Q" => "O que é Descentralização?",
    "FAQ_2_A" => "Criptomoedas operam em redes descentralizadas, como a tecnologia blockchain, o que elimina a necessidade de intermediários como bancos. Esta descentralização proporciona transparência, segurança e controle sobre as transações.",
 
    "FAQ_3_Q" => "Quais são as Criptomoedas Mais Populares para Trading de Cripto?",
    "FAQ_3_A" => "Bitcoin (BTC) é a primeira e mais conhecida criptomoeda, abrindo caminho para uma infinidade de outras criptomoedas. Ethereum (ETH), Litecoin (LTC), Ripple (XRP) e muitas outras ganharam significativa popularidade e capitalização de mercado.",
 
    "FAQ_4_Q" => "Os Mercados de Cripto são voláteis?",
    "FAQ_4_A" => "Os preços das criptomoedas podem ser altamente voláteis, oferecendo tanto oportunidades quanto riscos para os traders. As flutuações de preço podem ser influenciadas por fatores como demanda de mercado, desenvolvimentos regulatórios, avanços tecnológicos e sentimento dos investidores.",
 
    "FAQ_5_Q" => "Quais são os usos das Criptomoedas?",
    "FAQ_5_A" => "Criptomoedas servem a vários propósitos, incluindo transações peer-to-peer, reserva de valor e ativos de investimento, e facilitação de smart contracts e aplicações descentralizadas (dApps) em plataformas blockchain",
 
    "FAQ_6_Q" => "Como Ser Bem-Sucedido nos Mercados de Cripto?",
    "FAQ_6_A" => "Manter-se atualizado com as notícias de criptomoedas, tendências de mercado e compreender a tecnologia subjacente é crucial para o sucesso no trading de criptomoedas.",
