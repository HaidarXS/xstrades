...
return [
    ...
    "XS_SOCIAL_MEDIA_DESCRIPTION" => "Kết nối với XS trên nền tảng truyền thông để trở thành một phần của cộng đồng trực tuyến sôi động. Luôn cập nhật những tin tức mới nhất, tham gia thảo luận. Theo dõi chúng tôi để cập nhật và tương tác theo thời gian thực.",
    "XS_MEDIA_KITS_DESCRIPTION" => "Hình ảnh và logo có độ phân giải cao. Bộ tài liệu báo chí để ra mắt sản phẩm hoặc thông báo quan trọng. Bộ công cụ truyền thông. Tờ thông tin cơ bản",
