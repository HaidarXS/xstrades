...
return [
    ...
    'REGULATIONS' => 'Giấy Phép',
    'PAGE_BANNER_SUBTITLE'=>'ham Gia Cùng Nhà Môi Đa Giấp Phép Được Cấp.',

    'REGULATIONS_DESCRIPTION' => 'XS Group là nhà cung cấp dịch vụ tài chính và công nghệ tài chính toàn cầu được cấp phép bởi các cơ quan quản lý của các khu vực tài chính có uy tín nhất trên toàn cầu.
    </br></br>
    ...
    'GROUP_ENTITIES_LICENCES' => 'Pháp nhân & Giấy phép',

    'XSLTD' => 'XS Ltd',

    'XSLTD_DESCRIPTION' => 'XS Ltd được cấp phép và quản lý bởi Cơ quan Dịch vụ Tài chính Seychelles (FSA) với số giấy phép: SD089.
    </br></br>
    ...
    'XS_PRIME_LTD_DESCRIPTION' => 'XS Prime Ltd được đăng ký theo luật pháp Úc với mã số công ty (141 194 934) và văn phòng đăng ký: MORRIS MENNILLI, SUITE 701 LEVEL 7 , 92 PITT STREET , SYDNEY NSW 2000.
    </br></br>
    ...
    XS Prime Ltd hoạt động dưới website www.xsprime.com',

    'XS_MARKETS_LTD' => 'Công ty TNHH thị trường XS',

    'XS_MARKETS_LTD_DESCRIPTION' => 'XS Markets Ltd được ủy quyền và quản lý bởi Ủy ban Chứng khoán và Giao dịch Cộng hòa Síp (CySEC) với số giấy phép 412/22.
    </br></br>
    ...
    'XS_FINTECH_LTD_DESCRIPTION' => 'XS Fintech Ltd được đăng ký tại Síp với số đăng ký HE 426566.
    </br></br>
    XS Fintech Ltd là Nhà cung cấp Giải pháp Fintech và là chi nhánh Công nghệ của XS Group.',

    'DISCLAIMER'=> 'Các thực thể trên được ủy quyền hợp pháp để hoạt động dưới thương hiệu và nhãn hiệu của XS Group.
    </br></br>
    ...
    'XS_ZA_PTY_DESCRIPTION' => 'XS ZA (Pty) Ltd được đăng ký theo luật pháp Nam Phi với số 2023/608801/07, văn phòng đăng ký: 38 Stella Road, Wetten, Cape Town, Western Cape, 7788.
    <br/><br/>
    ...
    <br/><br/>
    Để biết thêm thông tin về cơ quan quản lý, vui lòng tham khảo  <a href="https://www.fsca.co.za/" target="blank">https://www.fsca.co.za/</a> ',
];