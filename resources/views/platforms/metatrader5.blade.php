...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT5') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT5') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT5') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT5') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT5') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT5') }}">
@endsection
@section('content')
    @include('layouts.banner', [
        'bannerTitle' => __('platforms.METATRADER_5'),
        'bannerDescription' => __('platforms.PAGE_DESC_MT5'),
        'bannerImage' => '/img/Platform/mt5.svg',
        'mobileBanner' => '/img/Platform/mt5-mobile.webp',
    ])


    <div class="container py-3 tabs-container">
    ...
    <section>
        <div class="row pb-2 pt-4">
            <h1 class="text-center text-navy fw-700">{!! __('platforms.METATRADER_5') !!}</h1>
        </div>
    </section>
    ...
    <section class="mb-5 text-md-start text-center">
        <div class="container">
            <div class="row">
                <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT5_Features') }}</h3>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.ADVANCED_CHARTING_TOOLS_INDICATORS') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
            ...
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.DEPTH_OF_MARKET_DOM') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.BUILT_IN_ECONOMIC_CALENDAR') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.HEDGING_CAPABILITY') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.EXPERT_ADVISORS_EAS') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.PREMIUM_TRADING_CONDITIONS') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-auto col-2 pe-0">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.MARKET_DEPTH_TIME_SALES_INFO') }}</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">
                            {{ __('platforms.PAGE_DESC_MT5') }}</h3>
                        <p class="col-12 text-dark-cust">{!! __('platforms.MT5_TRADING_PLATFORM_DESKTOP') !!}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mt-5">
        <div class="container">
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-lg-35 col-md-4 col-sm-6 col-9 mb-3">
                    <div class="d-flex w-100 align-items-center h-100 ">
                        <img style="max-width:50px" src="{{ asset('/img/laptop.png') }}"
                            alt="{{ __('platforms.WEB') }}">
            ...
            {{-- <div class="col-lg-8 m-auto mb-3">
                <h4 class="col-12 my-3 text-center text-secondary">{{ __('platforms.FOR_MORE_INFO_HELP') }}</h4>
            </div>
