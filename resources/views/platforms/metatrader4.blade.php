...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT4') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT4') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT4') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT4') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT4') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT4') }}">
@endsection
@section('content')
    <style>
    ...
    @include('layouts.banner', [
        'bannerTitle' => __('platforms.METATRADER_4'),
        'bannerDescription' => __('platforms.PAGE_DESC_MT4'),
        'bannerImage' => '/img/Platform/mt4.svg',
                ...
                <a href="{{ route('metatrader-4-desktop', ['lang' => App::getLocale()]) }}"
                    ...
                    <div class="d-flex flex-column h-100">
                        <svg fill="#dadada" height="100" width="100" class="platforms" x="0px" y="0px"
                            ...
                            <path
                                d="M3.32,18.85l56.37-7.77v54.47H3.32V18.85z M3.32,118.51l56.37,7.77V72.49H3.32
    ...
    <section>
        <div class="row pb-2 pt-4">
            <h1 class="text-center text-navy fw-700">{!! __('platforms.METATRADER_4') !!}</h1>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <div class="row">
                <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT4_FEATURES') }}</h3>
            </div>
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.INTUITIVE_INTERFACE') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-auto col-md-1 col-2 pe-0 mt-1">
            ...
            <div class="row">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.CUSTOMIZABLE_LAYOUTS') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-auto col-md-1 col-2 pe-0 mt-1">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.AUTOMATED_TRADING_OPTIONS') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-auto col-md-1 col-2 pe-0 mt-1">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.ONE_CLICK_TRADING') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-auto col-md-1 col-2 pe-0 mt-1">
                ...
                <div class="col-sm-11 col-10 px-0">
                    <p class="subttl text-navy">{{ __('platforms.REAL_TIME_MARKET_QUOTES') }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-auto col-md-1 col-2 pe-0 mt-1">
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        <h3 class="col-12 text-center text-navy text-capitalize my-3">
                            {{ __('platforms.TRADE_THE_GLOBAL_MARKETS') }}</h3>
                        <p class="col-12 text-dark-cust">{!! __('platforms.TRADE_WITH_CONFIDENCE_MT4') !!}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mt-5">
        <div class="container">
            ...
            {{-- <div class="col-lg-8 m-auto mb-3">
                <h4 class="col-12 my-3 text-center text-secondary">{{ __('platforms.FOR_MORE_INFO_HELP') }}
                </h4>
