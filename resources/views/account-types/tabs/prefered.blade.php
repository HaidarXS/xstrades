    ...
    <div class="row">
        ...
        <div class="col-md-4  py-5">
            <div
                ...
                <div class="my-5 text-center">
                    <a href="{{ route('account_type_details', ['lang' => App::getLocale(), 'type' => 'preffered', 'account_type' => 'cent-account']) }}"
        ...
        <div class="col-md-4">
            <div
                ...
                <div class="mx-4 my-4">
                    <div class="p-1 text-center">
                        ...
                        <div>
                            ...
                            {{ __('account_types.SHARES_MT5') }}<br />
                ...
                <div class="my-5 text-center">
                    <a href="{{ route('account_type_details', ['lang' => App::getLocale(), 'type' => 'preffered', 'account_type' => 'standard-account']) }}"
                        class="text-secondary text-decoration-none text-center">
                        {{ __('account_types.MORE_DETAILS') }}
                    </a>
                </div>
        ...
        <div class="col-md-4 py-5">
            <div
                ...
                <div class="my-5 text-center">
                    <a href="{{ route('account_type_details', ['lang' => App::getLocale(), 'type' => 'preffered', 'account_type' => 'micro-account']) }}"
                        class="text-secondary text-decoration-none text-center">
                        {{ __('account_types.MORE_DETAILS') }}
                    </a>
                </div>
