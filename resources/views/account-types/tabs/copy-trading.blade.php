 <section id="partners">
     <div class="row justify-content-center">
         <div class="col-12 text-center mt-5 mb-3">
             <h1 class="text-secondary text-center fw-700">{{ __('account_types.COPY_TRADING_ACCOUNT_TYPES') }}</h1>
         </div>
         ...
         <div class="col-md-4 py-5">
             <div
                 ...
                 <div class="bg-primary text-white p-4">
                     <h2 class="text-center fw-700 text-uppercase">{{ __('account_types.COPY_STANDARD') }}</h2>
                 </div>
                 <div class="mx-4 my-3">
         ...
         <div class="col-md-4 py-5">
             <div
                 class="w-100 h-100 d-flex flex-column  border-radius-30 overflow-hidden border border-1 defualt-opacity shadow">
                 <div class="bg-primary text-white p-4">
                     <h2 class="text-center fw-700  text-uppercase">{{ __('account_types.COPY_PRO') }}</h2>
                 </div>
                 <div class="mx-4 my-3">
                     <div class="bg-gray p-1 text-center">
                         <h5 class="text-primary">
