<div class="row">
    <div class="col-12 text-center my-4">
        <h1 class="text-secondary fw-700 text-center">{{ __('dynamic-leverage.FX_EXOTICS') }}
        </h1>
    </div>
    ...
    <section>
        ...
        <ul class="nav nav-tabs d-flex justify-content-lg-between justify-content-center col-lg-7 col-12 mx-auto"
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="example1-tab" data-bs-toggle="tab" data-bs-target="#exoticsexample1"
                    type="button" role="tab" aria-controls="home"
                    aria-selected="true">{{ __('dynamic-leverage.EXAMPLES_1') }}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="example2-tab" data-bs-toggle="tab" data-bs-target="#exoticsexample2"
                    type="button" role="tab" aria-controls="profile"
                    aria-selected="false">{{ __('dynamic-leverage.EXAMPLES_2') }}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="example3-tab" data-bs-toggle="tab" data-bs-target="#exoticsexample3"
                    type="button" role="tab" aria-controls="contact"
                    aria-selected="false">{{ __('dynamic-leverage.EXAMPLES_3') }}</button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="exoticsexample1" role="tabpanel" aria-labelledby="home-tab">

                <div class="row">


                    <div class="col-12 text-center my-4">
                        <p class="">{{ __('dynamic-leverage.CONSIDER_A_USDZAR') }}</p>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td>1:200</td>
                                <td>0.5%</td>
                                <td>20 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 200 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>10,000.00 USD</td>
                            </tr>
                            <tr class="fw-700">
                                <td class="fw-800" colspan="4">{{ __('dynamic-leverage.TOTAL_REQUIRED') }}</td>
                                <td class="green-td fw-800">10,000.00 USD</td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="tab-pane fade" id="exoticsexample2" role="tabpanel" aria-labelledby="profile-tab">

                <div class="row">

                    <div class="col-12 text-center my-4">
                        <p class="">{{ __('dynamic-leverage.CONSIDER_A_EURZAR') }}</p>
                        <p class="">{{ __('dynamic-leverage.MARGIN_REQUIRED') }}</p>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td>1:100</td>
                                <td>1%</td>
                                <td>30 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 100 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>30,000.00 EUR</td>
                            </tr>
                            <tr>
                                <td>5</td>
                                <td>1:50</td>
                                <td>2%</td>
                                <td>5 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 50 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>10,000.00 EUR</td>
                            </tr>

                            <tr class="fw-700">
                                <td class="fw-800" colspan="4">{{ __('dynamic-leverage.TOTAL_REQUIRED') }}</td>
                                <td class="green-td fw-800">50,000.00 EUR</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td class="green-td fw-800">55,000.00 USD</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="exoticsexample3" role="tabpanel" aria-labelledby="contact-tab">
                <div class="row">


                    <div class="col-12 text-center my-4">
                        <p class="">{{ __('dynamic-leverage.CONSIDER_A_USDZAR_105LOTS') }}</p>
                        <p class="">{{ __('dynamic-leverage.MARGIN_REQUIRED') }}</p>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td>1:50</td>
                                <td>2%</td>
                                <td>50 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 50 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                            ...
                            <tr>
                                ...
                                <td>1:25</td>
                                <td>4%</td>
                                <td>5 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 25 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>20,000.00 USD</td>
                            </tr>

                            <tr class="fw-700">
                                <td class="fw-800" colspan="4">{{ __('dynamic-leverage.TOTAL_REQUIRED') }}</td>
                                <td class="green-td fw-800">160,000.00 USD</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td class="green-td fw-800">24,000,000.00 JPY</td>
                            </tr>
                        </table>
                    </div>
                </div>
