<div class="row">
    <div class="col-12 text-center my-4">
        <h1 class="text-secondary fw-700 text-center">{{ __('dynamic-leverage.FX_MAJORS') }}
        </h1>
    </div>
    ...
    <section>
        ...
        <ul class="nav nav-tabs d-flex justify-content-lg-between justify-content-center col-lg-7 col-12 mx-auto"
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="example1-tab" data-bs-toggle="tab" data-bs-target="#example1"
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="example1" role="tabpanel" aria-labelledby="home-tab">

                <div class="row">

                    <div class="col-12 text-center my-4">
                        <p class="">{{ __('dynamic-leverage.CONSIDER_A_USD_ACCOUNT') }}</p>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td>1:2000</td>
                                <td>0.05%</td>
                                <td>2 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 2000 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>100.00 USD</td>
                            </tr>
                            <tr>
                                <td class="fw-800" colspan="4">{{ __('dynamic-leverage.TOTAL_REQUIRED') }}</td>
                                <td class="green-td fw-800">100.00 USD</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10 total-table">
                            <tr class="table-header">
            ...
            <div class="tab-pane fade" id="example2" role="tabpanel" aria-labelledby="profile-tab">

                <div class="row">

                    <div class="col-12 text-center my-4">
                        <p class="">{{ __('dynamic-leverage.CONSIDER_A_USD_ACCOUNT_EUR') }}</p>
                        <p class="">{{ __('dynamic-leverage.MARGIN_REQUIRED') }}</p>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td>1:1000</td>
                                <td>0.1%</td>
                                <td>8 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 1000 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>800.00 EUR</td>
                            </tr>
                            <tr>
                                <td>5</td>
                                <td>1:500</td>
                                <td>0.2%</td>
                                <td>5 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 500 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>1,000.00 EUR</td>
                            </tr>
                            <tr>
                                <td class="fw-800" colspan="4">{{ __('dynamic-leverage.TOTAL_REQUIRED') }}</td>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10 total-table">
                            ...
                            <tr>
                                ...
                                <td class="green-td fw-800">2,090.00 USD</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="example3" role="tabpanel" aria-labelledby="contact-tab">
                <div class="row">


                    <div class="col-12 text-center my-4">
                        <p class="">{{ __('dynamic-leverage.CONSIDER_A_JPY_ACCOUNT') }}</p>
                        <p class="">{{ __('dynamic-leverage.MARGIN_REQUIRED') }}</p>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10">
                            ...
                            <tr>
                                ...
                                <td>1:500</td>
                                <td>0.2%</td>
                                <td>40 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 500 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>8,000.00 USD</td>
                            </tr>
                            <tr>
                                <td>50</td>
                                <td>1:200</td>
                                <td>0.5%</td>
                                <td>50 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 200 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                                <td>25,000.00 USD</td>
                            </tr>
                            <tr>
                                <td>100</td>
                                <td>1:100</td>
                                <td>1%</td>
                                <td>100 ({!! __('dynamic-leverage.LOTS') !!}) * 100,000 / 100 ({!! __('dynamic-leverage.LEVERAGE') !!})</td>
                            ...
                            <tr>
                                <td class="fw-800" colspan="4">{{ __('dynamic-leverage.TOTAL_REQUIRED') }}</td>
                                <td class="green-td fw-800">173,900.00 USD</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-8 col-10 text-center mb-5 d-flex justify-content-center mx-auto">
                        <table cellpadding="10" cellspacing="0" class="fs-md-10 total-table">
                            ...
                            <tr>
                                ...
                                <td class="green-td fw-800">26,085,000.00 JPY</td>
                            </tr>
                        </table>
                    </div>
                </div>
