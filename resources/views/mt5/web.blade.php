...
@section('opengraph')
    ...
    <meta property="og:title" content="{{ __('seo.TITLE_MT5_WEB') }}">
    <meta property="og:description" content="{{ __('seo.DESCRIPTION_MT5_WEB') }}">
    ...
    <meta name="twitter:title" content="{{ __('seo.TITLE_MT5_WEB') }}">
    <meta name="twitter:description" content="{{ __('seo.DESCRIPTION_MT5_WEB') }}">
@endsection
@section('meta_tags')
    @parent
    <title>{{ __('seo.TITLE_MT5_WEB') }}</title>
    <meta name="description" content="{{ __('seo.DESCRIPTION_MT5_WEB') }}">
@endsection
@section('content')
    <style>
        ...
        <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
            ...
            <li class="mx-4" role="presentation">
                <a href="{{ route('metatrader-5-web', ['lang' => App::getLocale()]) }}"
                    class="text-primary fw-700 nav-link text-center h-100">
                    <div class="d-flex flex-column h-100">
                        <svg fill="#30af85" height="100" width="100" version="1.1" class="platforms" x="0px" y="0px"
                            viewBox="0 0 149.59 137.46" style="enable-background:new 0 0 149.59 137.46;">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="row">
                                <h3 class="col-12 text-center text-navy text-capitalize my-3">
                                    {{ __('platforms.ACCESS_YOUR_ACCOUNT_WEB') }}</h3>
                                <p class="col-12 text-dark-cust text-center">{{ __('platforms.ON_THE_GO_WEB') }}</p>
                            </div>
                        </div>
                        <div class="row mx-auto justify-content-center">
                            <div class="pt-4 d-flex justify-content-center">
                                <a href="{{ route('webtrader-checked', ['lang' => App::getLocale(), 'platform' => 'mt5']) }}"
                                    class="btn join-us-button py-3 px-5 fw-700">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="me-3"><img class="btn-icon"
                                                src="{{ asset('/svgs/download-ic.svg') }}"
                                                alt="{{ __('platforms.MT5_DOWLOAD_WEB') }}"
                                                style="width: 30px; object-fit: contain;">
                                        </span>
                                        <span>
                                            {{ __('platforms.MT5_DOWLOAD_WEB') }}
                                        </span>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-10 align-items-center d-flex">
                                    <ol>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.LAUNCH_MT5_WEB_PLATFORM') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.CLICK_FILE_TOP_MENU') }}</li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.SELECT_LOGIN_TRADE_ACCOUNT') }}
                                        </li>
                                        <li class="text-dark-cust mb-3">{{ __('platforms.ENTER_XS_CREDENTIALS_SERVER') }}
                                        </li>
                                ...
                                <div class="col-sm-6 col-10 col-sm-6 col-10 m-sm-0 m-auto">
                                    <img src="{{ asset('/img/Group 3777.png') }}" class="img-fluid h-100"
                                        alt="xs account">
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <div class="container">
                    <div class="row">
                        <h3 class="col-12 text-navy text-capitalize my-3">{{ __('platforms.MT5_WEB_FEATURES') }}</h3>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.WEB_BASED_METATRADER') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.NO_INSTALLATION_REQUIRED') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.REAL_TIME_MARKET_DATA_EXECUTION') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11 col-10 px-0">
                            <p class="subttl text-navy">{{ __('platforms.COMPATIBLE_WITH_WINDOWS_MAC_LINUX') }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div
