<style>
    ...
    #withdraw-section-btn>div {
        background-color: #30af85 !important;
    }

    #withdraw-section-btn>div>h3 {
        /* background-color:#30af85; */
        color: #fff !important;
    }
</style>
<section id="withdraw-section" class="bg-gray py-5">
    <div class="container">
        <div class="row mt-5">
                ...
                <table class="table table-bordered table-striped">
                    <thead class="">
                        <tr class="bg-primary text-center text-white">
                            ...
                            <th class="py-3" scope="col">{{ __('funding_methods.MIN_WITHDRAWAL') }}</th>
                            <th class="py-3" scope="col">{{ __('funding_methods.MAX_WITHDRAWAL') }}</th>
                    ...
                    @if (session()->get('locale') == 'jp')
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td class="py-3">6.69 USD</td>
                                <td class="py-3">13,382.00 USD</td>
                                <td class="py-3">1営業日</td>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">3,000 JPY</td>
                                <td class="py-3">2,000,000 JPY</td>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">5 USD</td>
                                <td class="py-3">25000 USD</td>
                                <td class="py-3">10営業日</td>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">10.00 USD</td>
                                <td class="py-3">30,000.00 USD</td>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">15.00 USD</td>
                                <td class="py-3">2,000.00 USD</td>
                                <td class="py-3">約30 - 45分以内</td>
                                <td class="py-3">USD</td>
                                <td class="py-3">
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">535.04 USD</td>
                                <td class="py-3">13,376.00 USD</td>
                                <td class="py-3">1営業日</td>
                                <td class="py-3">USD、JPY</td>
                                <td class="py-3">
                                    <a href="https://my.XSTrades.com/{{ getCorrectLangSlug() }}register/?sl=1"
                    ...
                    @else
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">5 USD</td>
                                <td class="py-3">25000 USD</td>
                                <td class="py-3">7-10 {{ __('funding_methods.WORKING_DAYS') }}</td>
                                <td class="py-3">EUR, USD, GBP</td>
                                <td class="py-3">
                                    <a href="https://my.XSTrades.com/{{ getCorrectLangSlug() }}register/?sl=1"
                                        target="_blank"
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">50 USD</td>
                                <td class="py-3">15000 USD {{ __('funding_methods.OR_EQUIVALENT') }}</td>
                                <td class="py-3"> 1 {{ __('funding_methods.BUSINESS_DAY') }}</td>
                                <td class="py-3">EUR, USD, GBP</td>
                                <td class="py-3">
                                    <a href="https://my.XSTrades.com/{{ getCorrectLangSlug() }}register/?sl=1"
                                        target="_blank"
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-3">2500 USD {{ __('funding_methods.OR_EQUIVALENT') }}</td>
