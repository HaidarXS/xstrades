...
@section('content')
    <div class="w-100 position-relative mb-5">
        <div class="position-absolute w-100 h-100 top-0 start-0 d-flex align-items-center justify-content-center">
            <h1 class="text-white text-uppercase fw-700 fw-banner text-uppercase">{{ __('security.PAGE_BANNER_TITLE') }}
            </h1>
        </div>
        <img src="{{ asset('img/security-banner.png') }}" alt="Security" class="img-fluid">
    </div>
    ...
    <section>
        <div class="container mb-4">
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="container">
                    <div class="row">
                        <h2 class="col-12 text-center text-navy text-capitalize pb-4 pt-4">
                            {{ __('security.SAFETY_MEASURES') }}
                        </h2>
                    </div>
                    <p class="col-12 mb-3 text-lg py-3">
                        <span class="text-secondary">{{ __('security.SAFETY_MEASURES_SUB') }}</span>
                    </p>
                    <p class="col-12 mb-3 text-lg py-3">
        ...
        <div class="container mb-4">
            <div class=" py-3 px-2 px-lg-5 grey-bg border-radius-50">
                <div class="col-lg-12 py-4 col-sm-12">
                    <div class="row">
                        <p class="col-12 mb-3 text-center px-5">{!! __('security.YOUR_ONLINE_SAFETY') !!}</p>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 ">
    ...
    <section>
        <div class="container mb-4">
            <div class="col-lg-12 col-md-12 col-sm-12 ">
                <div class="container">
                    <div class="row">
                        <h2 class="col-12 text-center text-navy pb-4">{{ __('security.BEWARE_OF_FRAUD') }}
                        </h2>
                        <p class="col-12 mb-3 text-lg py-3">
                            <span class="text-secondary">{!! __('security.BEWARE_OF_FRAUD_SUB') !!}</span>
                        </p>
                        <p class="col-12 mb-3 text-lg py-3">
                            <span class="text-secondary">{{ __('security.HOW_TO_SPOT') }}</span>
                        </p>
                    </div>
                    <p class="col-12 mb-3 text-lg py-3">
